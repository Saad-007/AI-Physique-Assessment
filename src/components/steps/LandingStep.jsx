  ...
  return (
    ...
    >
      ...
      <motion.div 
        ...
        className="border border-gray-800/80 bg-[#0a0a0a]/80 backdrop-blur-md rounded-full px-4 py-1.5 text-[11px] text-gray-400 font-bold tracking-[0.2em] uppercase mb-8 flex items-center gap-2 shadow-xl cursor-default"
      >
      ...
      <motion.h1 
        variants={itemVariants}
        className="text-5xl md:text-6xl lg:text-7xl font-black uppercase tracking-tighter leading-[0.95] mb-6 text-balance text-white"
      >
      ...
      <motion.p 
        variants={itemVariants}
        className="text-gray-400 text-base md:text-lg max-w-lg mb-12 leading-relaxed font-medium text-balance"
      >
      ...
      <motion.div 
        variants={itemVariants}
        className="flex flex-wrap justify-center gap-8 md:gap-20 mb-12 w-full"
      >
        {[
      ...
      <motion.div 
        variants={itemVariants}
        className="mt-10 flex items-center justify-center gap-2 px-4 py-2 rounded-full bg-white/[0.02] border border-white/[0.05] text-[11px] md:text-xs text-gray-500 font-semibold tracking-wide"
      >
